...
rule hlahd:
    ...
    shell:
        """hlahd.sh -m {params.min_lengh} -c {params.cut_perc} -t {threads} -f {params.freq_data} {input.chr6fastqfile1} {input.chr6fastqfile2} {params.split_file} {params.dictionary} {params.name} {params.output_dir}"""
