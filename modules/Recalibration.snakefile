...
rule  Indel_realigner_sentieon:
    ...
    dbsnp=_dbsnp,
	mills=__Mills_indels,
	g1000=__G1000_indels,
    threads: _realigner_threads
    shell:
	   """{params.index1}/sentieon driver -r {params.index} -t {threads} -i {input.bam} --algo Realigner -k {params.Mills_indels} -k {params.G1000_indels} {output.realignbam}"""
