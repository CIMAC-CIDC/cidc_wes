def germlinevcf_runsHelper(wildcards, iindex):
    ...
    if len(r) >=2:
        ...
        tmp.append("analysis/germline/%s/SNP92.recode.vcf" %sample_name)
    else:
...
rule vcftoolsdiff:
    ...
    output:
        "analysis/germline/{run}/{run}.diff.sites_in_files",
...
rule testmatch:
    ...
    shell:
        "python /homes/jjyu/wes_project/cidc_wes/modules/scripts/Match.py {input} > {output}"
