...
rule optitype_hlatyping:
    ...
    This will produce a time-stamped directory inside the specified output 
    directory containing a CSV file with the predicted optimal (and if enumerated, sub-optimal)
    HLA genotype, and a pdf file containing a coverage plot of the predicted alleles for 
    diagnostic purposes."""
    ...
    shell:
        """python {params.PathtoOptiType}/OptiTypePipeline.py -i in_chr6fastqfile1 in_chr6fastqfile2
        --dna -v -o analysis/HLATyping/ -p {params.outputname}
