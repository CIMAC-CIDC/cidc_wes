...
def main():
    ...
    optparser.add_option("-m", "--normal_xhla", help="normal file", default=None)
    optparser.add_option("-t", "--tumor_opti", help="tumor file", default=None)
    optparser.add_option("-u", "--tumor_xhla", help="tumor file", default=None)

    optparser.add_option("-o", "--output", help="output file", default=None)
    (options, args) = optparser.parse_args(sys.argv)

    if not options.run or not options.tumor_opti or not options.normal_opti or not options.output:
