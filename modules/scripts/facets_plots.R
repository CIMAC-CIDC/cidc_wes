...
write.table(df,paste0(arg_out,arg_name,'.purity.txt'), quote=F, sep="\t", row.names=F)
write.table(df.iter, paste0(arg_out,arg_name,'.purityfinal.txt') , quote=F, sep="\t", row.names=F)
}
