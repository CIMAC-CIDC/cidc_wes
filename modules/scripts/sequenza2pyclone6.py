...
pyclone_vi expected header:
mutation_id	sample_id     ref_counts	alt_counts	major_cn	minor_cn	normal_cn	

NOTE: you can also provide tumour_content (i.e. tumor cellularity) which I
thought relates to purity, but it does not!
"""
...
def main():
    ...
    #rearange cols:
    df = df[['mutation_id', 'sample_id', 'ref_counts', 'alt_counts','major_cn',
             'minor_cn', 'normal_cn']]
