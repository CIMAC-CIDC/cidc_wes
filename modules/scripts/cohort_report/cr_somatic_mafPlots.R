...
generateMafPlots <- function(mafs, cancerGeneList_f, vaf_png_f, tcga_png_f, interact_png_f, lolli1_png_f, lolli2_png_f, lolli3_png_f, lolli4_png_f, lolli5_png_f) {
   #png(summary_png_f);
...
arg_tcga_png_f = args[4]
arg_interact_png_f = args[5]

arg_lolli1_png_f = args[6]
arg_lolli2_png_f = args[7]
arg_lolli3_png_f = args[8]
arg_lolli4_png_f = args[9]
arg_lolli5_png_f = args[10]

mafs = read.maf(maf=arg_in)

#this is starting to get ugly!
generateMafPlots(mafs, args_geneList, arg_vaf_png_f, arg_tcga_png_f, arg_interact_png_f, arg_lolli1_png_f, arg_lolli2_png_f, arg_lolli3_png_f, arg_lolli4_png_f, arg_lolli5_png_f)
