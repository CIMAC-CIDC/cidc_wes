...
Script to use stringent cut-offs to make GAIN or LOSS copy number region calls

Based on recommendations from Chen et al., bioRxiv 2021, the default 
gain-cutoff is 3 and the loss cut-off is 1.5
...
def main():
    ...
    optparser.add_option("-o", "--output", help="output gain/loss calls with stringent cut-offs")
    optparser.add_option("-g", "--gain_cutoff", help="total copy number cut-off for gains, default: 3", default="3")
    optparser.add_option("-l", "--loss_cutoff", help="total copy number cut-off for losses, default: 1.5", default="1.5")
