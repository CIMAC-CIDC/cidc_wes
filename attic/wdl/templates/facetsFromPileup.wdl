# https://portal.firecloud.org/#methods/jakec/FACETSfromPileup/1/wdl
# Run FACETS when you already have a pileup file
# breardon@broadinstitute.org, jakec@broadinstitute.org
# If you need to also calculate the pileup file for FACETS use jakec/FACETS
